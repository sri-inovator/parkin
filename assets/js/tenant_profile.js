...
let park_place = document.querySelectorAll(".park_pl")
park_place.forEach(e=>{
...
let pay = document.querySelectorAll(".paym")
pay.forEach(p=>{
    p.addEventListener("click", (b)=>{
        window.location.href = "tenant-payment.html?name=" + res["Email"]
